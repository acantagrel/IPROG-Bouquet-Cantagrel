...
namespace IPROG_Alice
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                nbTirDispo = 5 - nbBateauCouléOrdi;
                ...
                for (int nbTir = 0; nbTir < nbTirDispo; nbTir++)
                {
                    ...
                    {
                        c1++;
                        TesterToucheCoule(PA, ref nbBateauCouléOrdi, ref couléPA);
                    }
                    while ((couléCuir == false) && (c2 == 0))
                    {

                        TesterToucheCoule(Cuir, ref nbBateauCouléOrdi, ref couléCuir);
                        c2++;
                    }
                    while ((couléSM == false) && (c3 == 0))
                    {
                        c3++;
                        TesterToucheCoule(SM, ref nbBateauCouléOrdi, ref couléSM);
                    }
                    while ((couléCrois == false) && (c4 == 0))
                    {
                        c4++;
                        TesterToucheCoule(Crois, ref nbBateauCouléOrdi, ref couléCrois);
                    }
                    while ((couléCT == false) && (c5 == 0))
                    {
                        c5++;
                        TesterToucheCoule(CT, ref nbBateauCouléOrdi, ref couléCT);
                    }
                    DessinerPlateau(tabOrdi);
                    DessinerPlateau(tabj1);
                }//for (nbTir<5)
